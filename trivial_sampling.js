...
//
var client = new Client(this, VLC_PLAYLIST, 8080);

var ratioX, radioY;
var marginX, marginY;
var url;
var cur_district = -1; // Current district
var div = [];
var msg = "";
var renewing = false;
var timer;
var timer_period = [60000, 5000];
var mode = 1; // Update mode => 0: city, 1: district
var cat = 0;  // Category
...
//***************************************
// Draw a progress bar on the top edge of the window
//
